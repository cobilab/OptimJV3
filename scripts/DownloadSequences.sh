...
urls=(
   ...
   "https://ftp.cngb.org/pub/gigadb/pub/10.5524/102001_103000/102231/plodia_hfib_flanking.fa" # 134.88KB, Genome sequence of h-fibroin plus flanking regions (1,000 bp each side) of Plodia interpunctella (bug), [DOI] 10.5524/102231, http://gigadb.org/dataset/102231
...
for url in "${urls_rev[@]}"; do
   ...
   if [[ ! -f "$rawSequencesPath/$origFile" ]]; then 
